...
public class BPMainController {
    ...
    void onClickAddComment(ActionEvent event)
    {
    	...
    	if(selectedItem != null)
    	{
    		...
    		Stage stage = (Stage) viewComment.getScene().getWindow();
    		stage.close();
    		
    		//show AddCommentView window
            model.showAddCommentView(selectedItem.getValue()); 
    	}
    }

    @FXML void onClickViewComment(ActionEvent event)
    {
    	...
    	if(selectedItem != null)
    	{
    		...
    		//show CommentView window
            model.showCommentView(selectedItem.getValue()); 
    	}
